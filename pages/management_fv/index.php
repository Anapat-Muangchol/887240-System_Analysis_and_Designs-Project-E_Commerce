                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <?php while ($row = mysqli_fetch_array($query)) { ?>
                            <tr>
                                ...
                                <td class="mailbox-subject"><a href="https://angsila.cs.buu.ac.th/~57160033/887240%20System%20Analysis%20and%20Designs/Project/Mockup/pages/post/detail/ProductDetail.php?idPost=<?php echo $row['idPost']; ?>"><?php echo $row['name']; ?></a></td>
